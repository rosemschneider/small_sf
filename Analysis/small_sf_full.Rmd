...
ggsave("~/Documents/Projects/small_sf/Analysis/Figures/study1_CP_subset_Unit.png", width = 6, height = 4)
```
...
ggsave("~/Documents/Projects/small_sf/Analysis/Figures/study2_CP_subset_Unit.png", width = 6, height = 4)
```
...
ggsave("~/Documents/Projects/small_sf/Analysis/Figures/study2_nKL_NNandUnit.png", width = 7, height = 3)
...
ggsave("~/Documents/Projects/small_sf/Analysis/Figures/study2_CPSubset_NNandUnit.png", width = 7, height = 3)
```
