...
In the course of learning about number, most children come to understand that the natural numbers are endless. While there are many potential paths to knowledge of numerical infinity (CITATIONS), one proposed mechanism is acquiring knowledge of the successor function [@cheung2017]. Although having some knowledge of this recursive function -- that every number \emph{n} has a successor, \emph{n}+1 -- does not necessarily entail understanding the infinite nature of number, it is a property of the integers which nevertheless logically guarantees their infinity. Supporting this hypothesis, recent work has found that children's knowledge of the successor function is generally correlated with their intuitions about infinity and the endlessness of numbers [@cheung2017] (CHU, under review - add citation). This work has found that, far from reflecting a generalized principle, children's successor knowledge is strikingly limited for several years; that is, even after becoming competent counters, children are only able to reason about successor relations for a fraction of the number words they know and produce. In this work, we explore the nature of this limited successor knowledge and the mechanisms that children may use to begin acquiring this logical principle. In particular, <<SPECIFIC QUESTION RE: MECHANISM AND SUBSET KNOWERS>>.
